...
namespace InternalTrainingSystem.Core.Repository.Implement
{
    public class CourseRepository : ICourseRepository
    {
        ...
        //    // 🔹 Ghi lịch sử duyệt khóa học vào CourseHistories
        ...
        //    // 🔔 Sau khi giám đốc duyệt xong -> gửi thông báo cho phòng đào tạo
        //    var trainingUsers = await _userService.GetUsersByRoleAsync(UserRoles.TrainingDepartment);

        //    if (trainingUsers?.Any() == true)
        //    {
        //        var isApproved = newStatus.Equals(
        ...
        //            notification,
        //            trainingUsers.Select(u => u.Id).ToList()
        //        );
        //    }
        //    return true;
        //}
