...
namespace InternalTrainingSystem.Core.Services.Interface
{
    ...
    {
        Task<QuizDetailDto?> GetQuizAsync(int quizId,string userId,bool shuffleQuestions = false,bool shuffleAnswers = false,CancellationToken ct = default); Task<StartQuizResponse> StartAttemptAsync(int quizId, string userId, CancellationToken ct = default);
